        ...
        <div class="container mt-4 w-100 " id="candidate-profile">
            <%
                ...
                try {
                    ...
                    String query = "SELECT * FROM applyjob WHERE id = ?";
                ...
                <div class="col-md-9 col-xs-12">
                    <div class="profile-descr">
                        ...
                        <div class="profile-details mt20">
                            <p>Front end developers use HTML, CSS, and JavaScript to code the website and web app designs created by web designers. The code they write runs inside the browser (as opposed to a back end developer, whose code runs on the web server). Being also in charge of making sure that there are no errors or bugs on the front end, as well as making sure that the design appears as its supposed to across various platforms and browsers.</p>
                        </div>
